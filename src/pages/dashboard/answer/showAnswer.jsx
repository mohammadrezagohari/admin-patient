...
import { showAnswer, updateAnswers } from "@/api/services/answer";
export function ShowAnswer() {
  ...
  const editInfoAnswer = async (id, values) => {
    const editResult = await updateAnswers(id, values)
  ...
  const showInfoAnswer = async (id) => {
    const showResult = await showAnswer(id)
      .then(function (response) {
