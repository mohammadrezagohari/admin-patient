...
import { deleteLevel, getLevel } from "@/api/services/level";
...
export function Level() {
  ...
  const getDatas = async () => {
    const result = await getLevel(userToken)
  ...
  const deleteLevels = async (id) => {
    const deleteResult = await deleteLevel(id, userToken)
      .then(function (response) {
                  ...
                  {displayedData?.map((level, key) => {
                    ...
                    return (
                      <tr key={key}>
                        ...
                        {/* <td className={className}>
                          <Typography className="text-xs font-semibold text-blue-gray-600">
                            {level?.quantity_questions}
                          </Typography>
                        </td>

                        <td className={className}>
                          <Typography className="text-xs font-semibold text-blue-gray-600">
                            {level?.answer_quantity}
                          </Typography>
                        </td> */}
