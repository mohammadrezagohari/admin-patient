...
import { deleteStorys, getStorys } from "@/api/services/story";
...
export function Story() {
  // const { stories, updateItems } = useSortableContext();
  ...
  // useEffect(() => {
  //   const sortable = new Sortable(storyListRef.current, {
  //     animation: 150,
  //     onEnd: (event) => {
  ...
  // useEffect(() => {
  //   const { data } = axios
  //     .get("https://testato.ir/api/story?count=100", {
  //       headers: {
  ...
  const deleteStory = async (id) => {
    const deleteResult = await deleteStorys(id)
      .then(function (response) {
        toast.success("حذف با موفقیت انجام شد !");
        console.log(response?.data);
        setStories(stories.filter((storie) => storie.id !== id));
        // return (
    ...
    // const { data } = axios
    //   .delete(`https://testato.ir/api/story/delete/${storyId}`, {
    //     headers: {
    //       "Content-Type": "application/json",
    //       Accept: "application/json",
                  ...
                  {displayedData?.map((story, key) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className={className}>
                          <Typography className="text-xs font-semibold text-blue-gray-600">
                            <img src={story?.image_preview} alt="" />
                          </Typography>
                        </td>
                        ...
                        <td className={className}>
                          <Typography className="text-xs font-semibold text-blue-gray-600">
                            <video controls>
                              <source src={story?.file_url} type="video/mp4" />
                            </video>
                          </Typography>
                        </td>
                        ...
                        <td className={className}>
                          <Link
                            to={`/dashboard/story/show/${story.id}`}
                            style={linkStyle}
                          >
                            اصلاح
                          </Link>
                          <Button
                            ...
                            className="w-16 bg-red-700 text-white hover:bg-red-800 focus:outline-none"
                          >
                            حذف
                          </Button>
                        </td>
